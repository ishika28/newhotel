...
@section('title',"Hotel Sneha-Room Detail")
								...
								<li>
									<div class="information-box">
										...
										<ul class="list-inline social-networks">
											<li><a href="https://www.facebook.com/pages/Hotel-Sneha/1033114743491914"><span class="icon-facebook"></span></a></li>
						...
						<div id="carousel-example-generic" class="carousel image-gallery slide" data-ride="carousel"> 
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="row">
										<div class="col-xs-4">
											<a href="images/img13.jpg" class="fancybox" ><img src="images/img-10.jpg" alt="image description"></a>
										</div>
										<div class="col-xs-4">
											<a href="images/img13.jpg" class="fancybox" ><img src="images/img-11.jpg" alt="image description"></a>
										</div>
										<div class="col-xs-4">
											<a href="images/img13.jpg" class="fancybox" ><img src="images/img-12.jpg" alt="image description"></a>
										</div>
									</div>
								</div>
								<div class="item">
